...
/**
 * Installs the pre-baked 800claw rootfs from local APK assets on first launch.
 *
...
final class ClawRuntimeBootstrap {
    ...
    static void setupRootfsIfNeeded(final Activity activity, final Runnable whenDone) {
        ...
        final ProgressDialog progress =
            ProgressDialog.show(activity, null, "Preparing 800claw rootfs...", true, false);
    ...
    private static void writeProotDistroPlugin() throws Exception {
        ...
        String plugin =
            ...
            "# Registers the pre-baked 800claw rootfs shipped inside the claw800\n" +
            ...
            "\n" +
            "DISTRO_NAME=\"800claw\"\n" +
            "DISTRO_COMMENT=\"Pre-baked 800claw rootfs shipped with the claw800 runtime APK.\"\n" +
            "\n" +
